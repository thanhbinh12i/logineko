                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-purple-100 text-lg">
                      Here's what's happening with your LogiNeko platform today.
                    </p>
                  </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {stats.map((stat, index) => {
                  ...
                  return (
                    <Card
                      key={stat.title}
                      className="rounded-2xl shadow-xl border-0 bg-white hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 group"
                    >
                      <CardContent className="p-6">
                        <div className="flex items-center justify-between">
                          ...
                          <div
                            className={`w-16 h-16 bg-gradient-to-br ${gradients[index]} rounded-2xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300`}
                          >
                ...
                <Card className="rounded-2xl shadow-xl border-0 bg-white hover:shadow-2xl transition-all duration-300">
                  <CardHeader className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-t-2xl border-b border-blue-100">
                    <CardTitle className="flex items-center justify-between text-gray-800">
                      ...
                      <Button
                        size="sm"
                        className="bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300"
                      >
                  ...
                  <CardContent className="p-6">
                    <div className="space-y-4">
                      {recentOrders.slice(0, 4).map((order, index) => (
                        <div
                          key={order.id}
                          className="flex items-center justify-between p-4 bg-gradient-to-r from-gray-50 to-blue-50 rounded-xl border border-gray-100 hover:shadow-md transition-all duration-300 hover:scale-[1.02]"
                        >
                ...
                <Card className="rounded-2xl shadow-xl border-0 bg-white hover:shadow-2xl transition-all duration-300">
                  <CardHeader className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-t-2xl border-b border-purple-100">
                    <CardTitle className="flex items-center justify-between text-gray-800">
                      ...
                      <Button
                        size="sm"
                        className="bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300"
                      >
                  ...
                  <CardContent className="p-6">
                    <div className="space-y-4">
                      {feedback.slice(0, 3).map((item, index) => (
                        <div
                          key={item.id}
                          className="p-4 bg-gradient-to-r from-gray-50 to-purple-50 rounded-xl border border-gray-100 hover:shadow-md transition-all duration-300 hover:scale-[1.02]"
                        >
                          ...
                          <div className="flex items-center justify-between">
                            <Badge
                              variant="outline"
                              className="text-xs text-purple-600 border-purple-200 bg-purple-50 rounded-full px-3 py-1"
                            >
                              {item.product}
                            </Badge>
                            <Badge
                ...
                <div className="flex justify-between items-center">
                  <div>
                    ...
                    <p className="text-green-100">
                      Manage your educational content and subscriptions
                    </p>
                  </div>
                            ...
                            <td className="px-6 py-4 whitespace-nowrap">
                              <div className="flex space-x-2">
                                ...
                                <Button
                                  size="sm"
                                  variant="outline"
                                  className="rounded-playful text-red-600 hover:bg-red-50"
                                >
            ...
            <div className="space-y-8">
              ...
              <div className="grid gap-6">
                {feedback.map((item) => (
                  <Card
                    key={item.id}
                    className="rounded-2xl shadow-xl border-0 bg-white hover:shadow-2xl transition-all duration-300"
                  >
                    <CardContent className="p-6">
                        ...
                        <div className="flex space-x-2 ml-4">
                          {item.status === "Pending" && (
                            <>
                              <Button
                                size="sm"
                                className="bg-green-600 hover:bg-green-700 text-white rounded-playful"
                              >
                                Approve
                              </Button>
                              <Button
